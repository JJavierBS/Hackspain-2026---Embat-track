...
## El problema: dos empresas, tres puntos de diferencia
...
**Puntuación de salud financiera a lo largo de 24 meses (gráfico original):**
...
## Lo esencial: seis preguntas que tiene que contestar vuestro sistema
...
## Qué debe hacer: cuatro cosas que tiene que saber hacer el sistema
...
## Los datos: qué hay en el dataset
...
## Requisitos: qué tiene que llevar la entrega
...
## Ideas: qué se puede vender con esto
